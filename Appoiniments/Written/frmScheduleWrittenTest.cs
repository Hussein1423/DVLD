...
namespace DVLDtest.Appoiniments.Written
{
    public partial class frmScheduleWrittenTest : Form
    {
        ...
        short _rows = 0;
        string fullName = "";
        public frmScheduleWrittenTest(int localDrivingLAID, string className, string name, int createdBy, short rows, string fullName = "", bool insert = true, int testAppointmentID = 0)
        {
            InitializeComponent();
        ...
        private void frmScheduleWrittenTest_FormClosed(object sender, FormClosedEventArgs e)
        {
            refresh?.Invoke();
        }
    }
