...
namespace DVLDtest.Appoiniments.Street
{
    public partial class frmScheduleStreetTest : Form
    {
        ...
        short _rows = 0;
        string fullName = "";
        public frmScheduleStreetTest(int localDrivingLAID, string className, string name, int createdBy, short rows, string fullName = "", bool insert = true, int testAppointmentID = 0)
        {
            InitializeComponent();
        ...
        private void frmScheduleStreetTest_FormClosed(object sender, FormClosedEventArgs e)
        {
            refresh?.Invoke();
        }
    }
