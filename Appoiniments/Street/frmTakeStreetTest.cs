...
namespace DVLDtest.Appoiniments.Street
{
    public partial class frmTakeStreetTest : Form
    {
        ...
        public frmTakeStreetTest(int createdBy, int DLappID, string className, string name, DateTime date, decimal fees, int testAppontmentID, int trial)
        {
            InitializeComponent();
        ...
        private void frmTakeStreetTest_FormClosed(object sender, FormClosedEventArgs e)
        {
            refresh?.Invoke();
        }
    }
