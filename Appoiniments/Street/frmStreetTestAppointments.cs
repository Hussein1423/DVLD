...
namespace DVLDtest.Appoiniments.Street
{
    public partial class frmStreetTestAppointments : Form
    {
        ...
        public frmStreetTestAppointments(int localDrivingID, int applicationID, int createdBy)
        {
            InitializeComponent();
            ...
            dgvTests.DataSource = clsTest.getAllTestsforSpecificLocalDrivingLicense(localDrivingID, 3);
        ...
        private void gabAddVision_Click(object sender, EventArgs e)
        {
            ...
            {
                if ((bool)row.Cells["IsLocked"].Value == false || ucDrivingLicenseApplicationInfo1.passedTests == 3)
                {
            ...
            if (!isFound)
            {
                ...
                frmScheduleStreetTest scheduleTest = new frmScheduleStreetTest(ucDrivingLicenseApplicationInfo1._localDrivingLicenseApplicationID, ucDrivingLicenseApplicationInfo1.lblClass.Text, ucApplicationBasicInfo1.lblApplicant.Text, _createdBy, rows, ucApplicationBasicInfo1.lblApplicant.Text);
        ...
        {
            dgvTests.DataSource = clsTest.getAllTestsforSpecificLocalDrivingLicense(ucDrivingLicenseApplicationInfo1._localDrivingLicenseApplicationID, 3);
            lblRecords.Text = dgvTests.RowCount.ToString();
        }
        ...
        private void takeTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (!isLocked)
            {
                ...
                frmTakeStreetTest takeTest = new frmTakeStreetTest(_createdBy, ucDrivingLicenseApplicationInfo1._localDrivingLicenseApplicationID, ucDrivingLicenseApplicationInfo1.lblClass.Text, ucApplicationBasicInfo1.lblApplicant.Text, dateTime, fees, testAppointmentID, trial);
        ...
        private void editDateToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (!isLocked)
            {
                int testAppointmentID = (int)dgvTests.CurrentRow.Cells["TestAppointmentID"].Value;
                short rows = (short)dgvTests.Rows.Count;
                frmScheduleStreetTest scheduleTest = new frmScheduleStreetTest(ucDrivingLicenseApplicationInfo1._localDrivingLicenseApplicationID, ucDrivingLicenseApplicationInfo1.lblClass.Text, ucApplicationBasicInfo1.lblApplicant.Text, _createdBy, rows, ucApplicationBasicInfo1.lblApplicant.Text, false, testAppointmentID);
                scheduleTest.refresh += refreshData;
                scheduleTest.ShowDialog();
            }
        }

        private void frmStreetTestAppointments_FormClosed(object sender, FormClosedEventArgs e)
        {
            refresh?.Invoke();
        }
    }
